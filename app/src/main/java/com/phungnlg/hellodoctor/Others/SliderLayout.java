...
import com.phungnlg.hellodoctor.MainActivity;
...
public class SliderLayout extends RelativeLayout {
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTransformerSpan = ATTRIBUTES
                .getInteger(com.daimajia.slider.library.R.styleable.SliderLayout_pager_animation_span, 1100);
        mTransformerId = ATTRIBUTES.getInt(com.daimajia.slider.library.R.styleable.SliderLayout_pager_animation,
        ...
        int visibility = ATTRIBUTES
                .getInt(com.daimajia.slider.library.R.styleable.SliderLayout_indicator_visibility, 0);
